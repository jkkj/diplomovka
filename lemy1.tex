...
\begin{lem}
Po použití operácie NH, ktorou vznikne hrana h, sa agent užnedostane do
...
\end{defin}
\begin{defin}
Cyklická mriežka v eľkosti n je graf $C_{n} \times C_{n}$.
\end{defin}

\begin{lem}
Pri konštrukcii portovej hrany urobí agent medzi otvorením prvého a druhého
portu najmenej tri kroky.
\end{lem}
\begin{proof}
Najmenší cyklus v mrižke má dĺžku štyri. Teda medzi otvorením dvoch portov
