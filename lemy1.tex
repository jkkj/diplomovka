...
vrchol, s ktorým má všetky ostatné dimenzie rovnaké. Z týchto viet tiež
vyplýva, že množiny, na ktoré sa rozdelí $n$ prvková množina vrcholov s
najvyšším možným počtom hrán v indukovanom podgrafe, indukujú podgrafy s
najvyšším možným počtom hrán pri danom počte vrcholov.
...
Ako sme ukázali, po rozdelení podľa dimenzie vedie v každej z dvoch množín
najvyšší možný počet hrán. Teda ak agent najprv prejde väčšiu množinu a
potom menšiu (ak sú rovnaké, je to jedno), tak v momente prejdenia väčšej
prešiel množinu vrcholov s najvyšším možným počtom hrán a je to v poriadku.
Tento lokálny predpoklad platí rekurzívne, teda tieto dve množiny bude 
prechádzať tak, že najprv
prejde väčšiu množinu z tých, na ktoré sa táto množina rozdelí. V nich opäť
začne prechádzať väčšiu atď. až kým nie sú množiny nedeliteľné -
jednovrcholové.

Potrebujeme ukázať, že  takto konštruovaná postupnosť je vhodná a spĺňa
tvrdenie vety. A to neslňa ... grrrrrrrrrrrrrrrr ........

Potrebujeme, aby prejdená množina spĺňala tvrdenie vety \ref{delenie} a vety
