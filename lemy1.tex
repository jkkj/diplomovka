...
buď nepárny výskyt len prechodov po súradnici k a po ostatných párny
počet alebo má nepárny počet prechodov práve po každej súradnici
danej dimenzie, v ktorej nevedie. 
V ostatnej dimenzii majú počet prechodov po každej súradnici navzájom rovnakú paritu.
\end{lem}
\begin{proof}
...
Najprv ukážeme, že pri každej konštrukcii grafu G, existuje portová hrana
