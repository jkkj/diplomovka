...
%\\ \\ 
%{\bf Kľúčové slová:} neurónové siete, umelá inteligencia, počítačové videnie, rozpoznávanie gest, rozpoznávanie ruky
%\end{center}
%\end{minipage}
\end{center}
%\eject % EOP v
...
%\\ \\
%{\bf Key words:} neural networks, artificial intelligence, computer vision, gesture recognition, hand recognition
%\end{center}
\end{minipage}
\end{center}
%\eject % EOP v
